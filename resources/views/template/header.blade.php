<a class="relative mx-auto block w-48 overflow-hidden rounded-lg bg-slate-200 shadow-xl shadow-slate-200 sm:w-64 sm:rounded-xl lg:w-auto lg:rounded-2xl"
   aria-label="Homepage" href="/"><img alt="" fetchpriority="high" width="960" height="960" decoding="async"
                                       data-nimg="1" class="w-full" style="color:transparent"
                                       sizes="(min-width: 1024px) 20rem, (min-width: 640px) 16rem, 12rem"
                                       srcset="https://transmit.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.pngamp;w=16&amp;q=75 16w, https://transmit.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=32&amp;q=75 32w, https://transmit.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=48&amp;q=75 48w, https://transmit.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=64&amp;q=75 64w, https://transmit.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=96&amp;q=75 96w, https://transmit.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=128&amp;q=75 128w, https://transmit.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=256&amp;q=75 256w, https://transmit.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=384&amp;q=75 384w, https://transmit.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=640&amp;q=75 640w, https://transmit.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=750&amp;q=75 750w, https://transmit.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=828&amp;q=75 828w, https://transmit.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=1080&amp;q=75 1080w, https://transmit.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=1200&amp;q=75 1200w, https://transmit.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=1920&amp;q=75 1920w, https://transmit.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=2048&amp;q=75 2048w, https://transmit.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fposter.11292dc0.png&amp;w=3840&amp;q=75 3840w"
...
<div class="mt-10 text-center lg:mt-12 lg:text-left"><p class="text-xl font-bold text-slate-900"><a href="/">Their
            Side</a></p>
    <p class="mt-3 text-lg font-medium leading-8 text-slate-700">Conversations with the most tragically misunderstood
        people of our time.</p></div>
<section class="mt-12 hidden lg:block">
    <h2 class="flex items-center font-mono text-sm font-medium leading-7 text-slate-900">
        ...
        <span class="ml-2.5">About</span></h2>
    <p class="mt-2 text-base leading-7 text-slate-700 lg:line-clamp-4">In this show, Eric and Wes dig deep to get to the
        facts with guests who have been labeled villains by a society quick to judge, without actually getting the full
        story. Tune in every Thursday to get to the truth with another misunderstood outcast as they share the missing
        context in their tragic tale.</p>
    <button type="button"
...
<section class="mt-10 lg:mt-12">
    <h2 class="sr-only flex items-center font-mono text-sm font-medium leading-7 text-slate-900 lg:not-sr-only">
        ...
        <span class="ml-2.5">Listen</span></h2>
    ...
    <ul role="list"
        ...
        <li class="flex"><a class="group flex items-center" aria-label="Spotify" href="/">
                ...
                <span class="hidden sm:ml-3 sm:block">Spotify</span></a></li>
        <li class="flex"><a class="group flex items-center" aria-label="Apple Podcast" href="/">
                <svg aria-hidden="true" viewBox="0 0 32 32" class="h-8 w-8 fill-slate-400 group-hover:fill-slate-600">
                ...
                <span class="hidden sm:ml-3 sm:block">Apple Podcast</span></a></li>
        <li class="flex"><a class="group flex items-center" aria-label="Overcast" href="/">
                <svg aria-hidden="true" viewBox="0 0 32 32" class="h-8 w-8 fill-slate-400 group-hover:fill-slate-600">
                    <path
                ...
                <span class="hidden sm:ml-3 sm:block">Overcast</span></a></li>
        <li class="flex"><a class="group flex items-center" aria-label="RSS Feed" href="/">
                <svg aria-hidden="true" viewBox="0 0 32 32" class="h-8 w-8 fill-slate-400 group-hover:fill-slate-600">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <span class="hidden sm:ml-3 sm:block">RSS Feed</span></a></li>
    </ul>
</section>
